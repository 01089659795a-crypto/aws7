...
public class Ex02_배열 {
	...
	public static void main(String[] args) {
		...
		/* 배열 p.211
	       ...
	       *   - 배열명.length
	       * */
	    //1.예시 korScores1과 num1은 int를 공통으로 사용 => num1은 int num1;//배열이 아님
		int korScores1 [] = new int[10];
		//2.예시 korScores2와 num2는 int[]를 공동으로 사용 => num2는 int []  num2;//배열
		int [] korScores2 = new int[10];
		
		int [] korScores3 = {1, 2, 3};
		//korScores3 = {4, 5, 6}; // 에러 발생. 선언과 동시에 초기화 할때만 사용
