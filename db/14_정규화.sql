...
# enrollment_unf 테이블은 정규화 되지 않은 테이블
use nf;
select * from enrollment_unf;

# 제1정규화 : 원자값 확인 
	# phone_number에 번화가 2개
...
# student_name과 phone_number가 student_id(기본키)에 종속툄 = > 제2정규화 
