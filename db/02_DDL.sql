...
# 테이블명이 키워드인 경우 `테이블명`을 이용
create table if not exists student(
	num char(10) primary key,
    name varchar(20) not null,
    contact varchar(13),
    res_num char(14),
    major_code char(3) not null # 전공코드는 외래키로 나중에 지정해야 함
);
...
# 테이블명 : major
# 컬럼1 - code, 타입 : 고정문자열 3자, 기본키
# 컬럼2 - name, 타입 : 가변문자열 15자, null 허용 안 함, 중복 안 됨
# 컬럼3 - boss_id, 타입 : 고정문자열 10자, null 허용
# 컬럼4 - address, 타입 : 가변문자열 30자, null 허용
