...
update product
set amount = amount + 29;

# abc123회원이 장바구니에 있는 모든 제품들을 구매
# => 구매 테이블에 구매 내역 추가 => 제품 재고 변경 => 장바구니 삭제
insert into buy(id, code, amount) values('abc123', 'ACC001', 1);
insert into buy(id, code, amount) values('abc123', 'ACC002', 1);
